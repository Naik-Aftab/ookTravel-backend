...
async function saveBankDetails(req, res, next) {
  try {
    const bank_details = await bankService.saveBankDetails(req.body.agent_id, req.body);
...
async function editBankDetails(req, res, next) {
  try {
    const bank_details = await bankService.editBankDetails(req.body.agent_id, req.body);
